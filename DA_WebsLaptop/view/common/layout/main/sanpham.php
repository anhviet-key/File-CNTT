...
$items_per_page = $_GET['per_page']?$_GET['per_page']:5;
$current_page = $_GET['page']?$_GET['page']:1;
$offset = ($current_page-1)*$items_per_page;
$list = mysqli_query($connection,"SELECT * from sanpham order by idsp DESC limit ".$items_per_page." OFFSET ".$offset."");
$total_records = mysqli_query($connection,"select * from sanpham");
                                ...
                                <div class="col-12">
                                    <ul class="pagination-box mb-3">
                                        ...
                                        <?php 
                                            ...
                                            ?>
                                            <a class="Previous text-primary" href="?c=sanpham&per_page=<?=$items_per_page?>&page=<?=$pre_page?>">Trước</a>
                                        </li>
                                        <li><?php for($num = 1;$num<=$total_page;$num++){?>
                                                <?php if($num!=$current_page){?>
                                            <a class="text-success border pb-0 pt-0 rounded-circle" href="?c=sanpham&per_page=<?=$items_per_page?>&page=<?=$num?>"><?=$num?></a>
                                                <?php }else {?>
                                        ...
                                        <li>
                                            ...
                                            ?>
                                            <a class="Next text-primary" href="?c=sanpham&per_page=<?=$items_per_page?>&page=<?=$next_page?>"> Kế tiếp </a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
