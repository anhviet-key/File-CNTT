...
<body>
    <div id="colorlib-main">
        ...
        <div class="row mb-5 ml-1 mr-1">
            ...
            ?>
            <div class="col col-xl-3 col-lg-4 col-md-6 grid mb-5">
                <div class="grid-front">
                    ...
                    <a href='?c=listvideo&id=<?php echo $rows["idsub"] ?>' title="<?php echo $rows['tensub'] ?>">
                        <div class="pd--sub">
                    ...
                    <div class="team--author">
                        <span>Tác giả</span>
                        <p class="icon--author" title="Nguyễn Anh Việt"><img class="img-boder"
                                src="public/user/assets/img/beauty.jpeg"></p>
                    </div>
                </div>
            </div>
        </div>
