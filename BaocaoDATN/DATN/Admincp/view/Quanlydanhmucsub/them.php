                        ...
                        <div class="text-primary col-sm-12 mt-5">
                            ...
                            <form action="" method="post" id="add_form" enctype="multipart/form-data">
                                ...
                                <div class="form-group text-left">
                                    ...
                                    <input type="text" class="form-control" name="tensub" id="tensub"
                                        placeholder="Nhập họ tên khóa học" required>
                                </div>
                        ...
                        <table class="table table-inverse">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="color:#1cc88a"><img src="../uploads/<?php echo $dsub['anhnd']; ?>"
                                            style="object-fit: cover;width:100%;height:80px;" class="img-thumbnail">
                                    </td>
