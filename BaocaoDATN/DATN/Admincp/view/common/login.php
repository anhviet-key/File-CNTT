...
if(Helper::is_submit('login'))
{
    ...
    $sql = "select * from user where email=:email and matkhau=:matkhau"; 
       ...
       $userad = Database::db_get_row($sql,$params);
    ...
    if(!empty($email) && !empty($matkhau))
    {
       ...
       else if($userad['kieunguoidung'] == 1)
       {
            $_SESSION['email'] = $email;
            $_SESSION['userad'] = $userad;
            header('location: TK.php');
           Role::set_logged($userad['email'],$userad['kieunguoidung'],$userad['hoten']);
           Helper::redirect(Helper::get_url('Admincp/?v=common&a=admin'));
       }
    }
}
        ...
        <form action="" method="post">
            ...
            <div class="form-group textbox">
                <div class="input-group">
                    ...
                    <input type="password" name="matkhau" id="matkhau" placeholder="Mật khẩu" required="required">
                </div>
            </div>
